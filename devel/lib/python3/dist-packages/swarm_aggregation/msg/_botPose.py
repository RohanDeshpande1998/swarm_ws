...
"""autogenerated by genpy from swarm_aggregation/botPose.msg. Do not edit."""
import codecs
import sys
...
class botPose(genpy.Message):
  _md5sum = "14f9cb1d05d7b333efc6809331fe9a60"
  _type = "swarm_aggregation/botPose"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """string[] bot_id
...
float64 z"""
  ...
  def serialize(self, buff):
    ...
    """
    try:
      length = len(self.bot_id)
      buff.write(_struct_I.pack(length))
      for val1 in self.bot_id:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.Struct('<I%ss'%length).pack(length, val1))
      length = len(self.botpose)
      buff.write(_struct_I.pack(length))
      for val1 in self.botpose:
        _v1 = val1.header
        _x = _v1.seq
